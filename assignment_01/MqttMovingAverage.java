...
public class MqttMovingAverage implements MqttCallback {
    ...
    public void messageArrived (String topic, MqttMessage message) throws MqttException {
        try {
            ...
            long timeDiff = currentTimeMillisIn - current;

            System.out.println("MovinAverage IN: " + currentTimeMillisIn + " diff: " + timeDiff + " msg: " + jo);
    ...
    public byte[] sample2json (double time, double value) {
        long currentTimeMillisOut = System.currentTimeMillis();

        JSONObject jo = new JSONObject();
        jo.put("time", time);
        jo.put("value", value);
        jo.put("current", currentTimeMillisOut);

        System.out.println("MovinAverage OUT: " + currentTimeMillisOut + " msg: " + jo);
